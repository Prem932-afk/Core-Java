...
//Q.7) Create a program where a Manager class inherits from an Employee class, and an Executive class inherits from Manager. Display the details for all three classes.
