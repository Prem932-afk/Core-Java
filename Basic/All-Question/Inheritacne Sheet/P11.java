//11.Implement a program where a Building class is inherited by a House class, and then a Mansion class inherits from House. Each class should have unique properties. 
