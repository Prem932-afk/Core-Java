//12.Create a program where a Bank Account class is inherited by a Savings Account class, which is then inherited by a Checking Account class. Each class should have a different method for calculating interest.
